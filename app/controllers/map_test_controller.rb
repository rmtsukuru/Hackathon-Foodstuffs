class MapTestController < ApplicationController
  ...
  def parse_query
    ...
    price_words = { cheap: 1..1, inexpensive: 2..2, expensive: 3..3, pricy: 3..4, exorbitant: 4..4, ludicrous: 4..4,  costly: 2..3, affordable: 1..2, low: 1..1, high: 3..4, }
    price_range = nil
  ...
  def ambiguous_distance_keyword
    ["far", "close", "around", "away", "block", "long", "short", "nearby", "near", "next", "neighborhood", "area"]
  end
end
